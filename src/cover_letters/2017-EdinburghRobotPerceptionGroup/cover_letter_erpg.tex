...
\greetto{Dear Mr. Fallon,} % Greeting text
\closeline{Sincerely yours,} % Closing text

\nameto{Mr. Maurice Fallon} % Addressee of the letter above the to address

\addrto{
Robot Perception Group \\ % To address
Room 1-29, Informatics Forum, \\
10 Crichton Street,\\
