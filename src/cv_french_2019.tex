...
Tout les articles scientifiques publi\'es peuvent \^etre t\'el\'echarg\'es
via l'archive ouverte HAL \url{https://hal.archives-ouvertes.fr/}\\

\large{\underline{PhD thesis :}}

\begin{itemize}%
\normalsize{\items} \footnotesize{\bibentry{phd:mnaveau:2016}}
\end{itemize}

\large{\underline{Journal papers :}}

\begin{itemize}%
\normalsize{\items} \footnotesize{\bibentry{stasse:frontiers:2018}}
\normalsize{\items} \footnotesize{\bibentry{mukovskiy:tro:2016}}
\normalsize{\items} \footnotesize{\bibentry{naveau:ral:2016}}
\end{itemize}%
...
\begin{itemize}%
\normalsize{\items} \footnotesize{\bibentry{stein:ichr:2017}}
\normalsize{\items} \footnotesize{\bibentry{ramirez:ichr:2016}}
\normalsize{\items} \footnotesize{\bibentry{matan:biorob:2016}}
\normalsize{\items} \footnotesize{\bibentry{carpentier:icra:2016}}
\normalsize{\items} \footnotesize{\bibentry{kudruss:ichr:2015}}
\normalsize{\items} \footnotesize{\bibentry{naveau:ichr:2014}}
\normalsize{\items} \footnotesize{\bibentry{stasse:ichr:2014}}
\end{itemize}
