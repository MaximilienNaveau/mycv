...
% \extrainfo{age : 25 -- Driving license -- French citizen}
% \photo[4cm]{../figures/photo_officiel_small.JPG}

\address{Toulouse}{}
\extrainfo{Driving license -- French citizen}
\photo[3cm]{../figures/photo_officiel_trunc.jpg}
...
\cventry{}{Language}{C/C++,python,bash, nix}{}{}{}
...
\begin{itemize}%
\items \footnotesize{\fullcite{phd:mnaveau:2016}}
\end{itemize}

\large{\underline{Journal papers :}}

\begin{itemize}%
\items \footnotesize{\fullcite{mukovskiy:tro:2016}}
\items \footnotesize{\fullcite{orthey:homotopic:2015}}
\items \footnotesize{\fullcite{naveau:ral:2016}}
\items \footnotesize{\fullcite{clever:ral:2017}}
\end{itemize}%
...
\begin{itemize}%
\items \footnotesize{\fullcite{ramirez:ichr:2016}}
\items \footnotesize{\fullcite{matan:biorob:2016}}
\items \footnotesize{\fullcite{carpentier:icra:2016}}
\items \footnotesize{\fullcite{kudruss:ichr:2015}}
\items \footnotesize{\fullcite{naveau:ichr:2014}}
\items \footnotesize{\fullcite{stasse:ichr:2014}}
\end{itemize}
